...
class AgentServiceTest {
    ...
    fun setUp() {
        ...
        toolService = mockk()
        agentService = AgentService(agentRepository, toolService)
    }

    @Test
    fun `getAgent should return built-in agent when name matches`() = runTest {
        // Given
    ...
    @Test
    fun `getAgent should return built-in ModelTestAgent when name matches`() = runTest {
        // Given
    ...
    @Test
    fun `getAgent should return built-in AgentBuilder when name matches`() = runTest {
        // Given
    ...
    @Test
    fun `getAgent should return null for unknown built-in agent`() = runTest {
        // Given
    ...
    @Test
    fun `getAllAgents should return only persisted agents (not SYSTEM agents)`() = runTest {
        // Given
        val persistedAgent = PlatformAgentMeta(
            name = "CustomAgent",
    ...
    @Test
    fun `deleteAgent should return false for built-in agents`() = runTest {
        // Given
        val agentName = "Masaic-Mocky"
    ...
    @Test
    fun `deleteAgent should return true for persisted agents`() = runTest {
        // Given
    ...
    @Test
    fun `saveAgent should save agent and register PyFunTools`() = runTest {
        // Given
        ...
        coEvery { agentRepository.upsert(any()) } returns PlatformAgentMeta(
            name = "TestAgent",
            description = "A test agent",
            systemPrompt = "Test system prompt",
            kind = AgentClass(AgentClass.OTHER)
    ...
    @Test
    fun `saveAgent should throw exception when agent name already exists`() = runTest {
        // Given
        val agent = PlatformAgent(
            name = "ExistingAgent",
            description = "A test agent",
        ...
        val existingAgent = PlatformAgentMeta(
            name = "ExistingAgent",
