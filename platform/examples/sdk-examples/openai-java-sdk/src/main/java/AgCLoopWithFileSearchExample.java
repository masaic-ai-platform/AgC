...
public class AgCLoopWithFileSearchExample {
    ...
    public void runSDKStreaming(OpenAIClient client) throws Exception {
        ...
        ChatCompletionCreateParams createParams = ChatCompletionCreateParams.builder()
                .addSystemMessage("Use the given file search tool to prepare answer. Do not frame any answer yourself, If tool fails then just return sorry message with cause of sorry message.")
                .addUserMessage("Find one reaction of Magnesium.")
                .model(MODEL)
                .tools(List.of(objectMapper.readValue(String.format(fileSearchTool(), API_KEY), ChatCompletionTool.class)))
                .build();
