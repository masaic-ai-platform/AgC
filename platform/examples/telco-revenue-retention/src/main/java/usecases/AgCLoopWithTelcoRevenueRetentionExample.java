...
public class AgCLoopWithTelcoRevenueRetentionExample {
    ...
    private static final String USER_QUERY = "Find high-value customers with repeated payment failures and unresolved complaints, and recommend actions to retain them.";
