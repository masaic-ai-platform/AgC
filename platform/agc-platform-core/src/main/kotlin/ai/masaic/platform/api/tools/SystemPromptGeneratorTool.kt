...
) : ai.masaic.platform.api.tools.ModelDepPlatformNativeTool(ai.masaic.platform.api.tools.PlatformToolsNames.SYSTEM_PROMPT_GENERATOR_TOOL, modelService, modelSettings) {
