...
object PlatformToolsNames {
    ...
    const val SYSTEM_PROMPT_GENERATOR_TOOL = "creating_Blueprint"
    const val TOOL_SELECTOR_TOOL = "assembling_Abilities"
    const val SAVE_AGENT_TOOL = "saving_your_personal_agent"
