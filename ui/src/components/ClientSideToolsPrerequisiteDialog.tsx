...
const ClientSideToolsPrerequisiteDialog: React.FC<ClientSideToolsPrerequisiteDialogProps> = ({
  ...
  const fetchCredentials = async () => {
    ...
    setError(null);
    try {
      const response = await apiClient.agentJsonRequest(`/v1/dashboard/tools/client_side/credentials`) as { creds: string };
        ...
        <DialogHeader>
          ...
          <DialogDescription className="text-left">
            ...
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                window.open('https://github.com/masaic-ai-platform/AgC/tree/main/platform/examples/telco-revenue-retention/README.md', '_blank');
              }}
            >
              Setup Instructions
            </a>
